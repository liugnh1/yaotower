...
R.registerAll('relics', [
  ...
  { id: "fire_aura",   name: "烈焰光环", rarity: "rare", desc: "每回合对敌人造成ATK×10%+层数/3的燃烧伤害", icon: "🔥",
    onTurn: (p, e, s) => { if (e && e.hp > 0) { const d = Math.max(3, Math.floor((p.atk || 10) * 0.10) + Math.floor((s ? s.totalFloor : 1) / 3)); e.hp -= d; } } },
  ...
  { id: "soul_link",    name: "灵魂链接", rarity: "epic", desc: "你对敌人造成伤害时回复18%生命", icon: "🔗",
  ...
  { id: "doom_clock",   name: "末日时钟", rarity: "legendary", desc: "第5回合起对敌人造成8%HP伤害，第10回合起提升至20%", icon: "🕐",
    onTurn: (p, e, s) => { if (e && e.hp > 0 && s) { var t = s.turnInFloor || 0; if (t >= 5) { var pct = t >= 10 ? 0.20 : 0.08; e.hp -= Math.floor(e.maxHp * pct); } } } },
  ...
  { id: "core_thunder", name: "雷霆之怒", rarity: "legendary", icon: "🌩️",
