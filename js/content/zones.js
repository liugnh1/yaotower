...
R.registerAll('zones', {
  ...
  // ===== v0.41 新增Zone =====
  desert:  { id: "desert",  name: "荒芜沙漠", icon: "🏜️", bg: "#1a1408", enemyPool: "desert",  scale: 1.25, desc: "无尽的黄沙之下埋藏着古老的秘密", relicPool: ["shadow_cloak","gamblers_dice","phoenix_feather","echo_stone"], equipSet: "流沙", equipBonus: { dodge: 0.08, atk: 3 }, equipBonus4: { dodge: 0.15, atk: 8 }, equipNames: { weapon:"流沙之刃", armor:"流沙轻甲", helm:"流沙头巾", ring:"流沙指环", amulet:"流沙护符" }, modifier: { id: "desert_storm", desc: "🏜️ 沙暴：每3回合随机降低命中" } },
