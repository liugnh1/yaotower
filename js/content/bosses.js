...
// Boss 按Zone ID索引（兼容旧数字key + 新Zone ID key）
R.registerAll('bosses', {
  plains:   { name: "平原领主·裂地者",  hp: 150, atk: 18, def: 5,  exp: "大地颤抖", icon: "🦏",
    skill: { name: "地震", desc: "对玩家造成2倍攻击力伤害", fn: (e, p) => { const d = Math.max(1, e.atk * 2 - p.def); p.hp -= d; return { dmg: d, msg: '🌍 裂地者释放地震！' }; } } },
  forest:   { name: "森林之王·苍古树精", hp: 220, atk: 22, def: 7,  exp: "万木臣服", icon: "🌲",
  ...
  cave:     { name: "矿洞主宰·晶石巨像", hp: 300, atk: 26, def: 10, exp: "坚不可摧", icon: "💎",
    skill: { name: "晶化", desc: "本回合防御翻倍并反弹伤害", fn: (e, p) => { e.def *= 2; e._thorns = true; return { msg: '💎 晶石巨像晶化了！防御翻倍', crystal: true }; } } },
  ruins:    { name: "废墟守护者·石像鬼", hp: 350, atk: 28, def: 8,  exp: "千年沉睡", icon: "🗿",
  ...
  frozen:   { name: "冰原之主·霜翼巨鹰", hp: 380, atk: 30, def: 9,  exp: "极寒风暴", icon: "🦅",
  ...
  voidgate: { name: "虚空守门人",         hp: 450, atk: 34, def: 12, exp: "魔塔在前", icon: "🌀",
  ...
  tower:    { name: "魔塔守门人",         hp: 550, atk: 38, def: 15, exp: "简单模式·终极之战", icon: "🛡️",
